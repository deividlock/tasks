...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'el texto introducido es invalido',
        checked         : 'debe ser seleccionado',
        empty           : 'debe completar este campo',
        min             : 'el texto introducido es muy corto',
        max             : 'el texto introducido es muy largo',
        number_min      : 'demasiado largo',
        number_max      : 'demasiado corto',
        url             : 'URL invalido',
        number          : 'el texto introducido no es numérico',
        email           : 'direccion de correo invalida',
        email_repeat    : 'el correo no coincide',
        password_repeat : 'la contraseña no coincide',
        repeat          : 'no coincide',
        complete        : 'este campo esta incompleto',
...
/*function mayuscula2(campo){
    $(campo).input(function() {
       $(this).val($(this).val().toUpperCase());
    });
}*/

mayuscula("input.upper");
mayuscula("textarea.upper");
// mayuscula2("select.uppercase");
